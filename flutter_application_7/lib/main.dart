...
import 'package:flutter_application_7/authentification/mdpoubliermedecin.dart';
import 'package:flutter_application_7/charcuteries.dart';
...
import 'package:flutter_application_7/Pain et Assimilés/pain.dart';
...
import 'package:flutter_application_7/soupes%20et%20potages/hlalem_aux_legumes.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/hlalem_aux_legumes': (context) => Hlalem(),
        '/mdpoubliermedecin': (context) => oublierMed(),
      },
    );
  }
}
